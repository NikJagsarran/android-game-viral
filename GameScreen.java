...
public class GameScreen extends Screen {
    ...
    int invBorderTop = pauseButton.getY() + (pauseButton.getHeight() - Assets.invBorder.getHeight()) / 2;
    ...
    int pausePopupButtonsHorizSpacing = (Assets.pausePopupBG.getWidth()
    		- (Assets.pausePopupResume.getWidth() + Assets.pausePopupMenu.getWidth())) / 3;
    ...
    private void initialize() {
        ...
        readyMenuButton = new Button((utils.CANVAS_WIDTH - Assets.gamePlayReadyMenuButton.getWidth()) / 2,
        ...
        pausePopupMenuButton = new Button(pausePopupBGX + Assets.pausePopupResume.getWidth()
        		+ 2 * (pausePopupButtonsHorizSpacing), pausePopupButtonsY,
        		Assets.pausePopupMenu, Assets.pausePopupMenuClicked);
    	...
    	gameOverButtonsY = (gameOverBGY + Assets.gameOverBG.getHeight()
    			+ gameOverBestScoreY + Assets.scoreDigits.getHeight() - Assets.gameOverReplay.getHeight()) / 2;
    	...
    	if (touchEvents != null) {
	        ...
	        for(int i = 0; i < len; i++) {
	            ...
	            // Go invincible if TOUCH_DOWN but not on the pause button.
	            		...
	            		&& !world.invDrained && !pauseButton.eventInBounds(event)) {
    ...
    **************************************************************************/
    ...
    private void drawInvincibilityMeter(Graphics g, float remaining, int alpha) {
    	...
    	g.drawPixmap(meterToDraw, invMeterLeft, invBorderTop, 0, 0, width, Assets.invMeter.getHeight(), alpha);
    }
   /**************************************************************************
    ...
    **************************************************************************/
    ...
    private void drawGameOverUI(Graphics g) {
        ...
        Constants.drawScore(g, digits, "" + Settings.highscore, gameOverScoresRight, gameOverBestScoreY);
    }
   /****************************************************************************************************************
    ******************************************** END PRESENT METHODS ***********************************************
    ****************************************************************************************************************/
