...
public class MainMenuScreen extends Screen {
  ...
  private void initialize() {
    ...
    playButton = new Button((utils.CANVAS_WIDTH - Assets.mainMenuPlayButton.getWidth()) / 2,
        (int) (utils.CANVAS_HEIGHT * 0.56), Assets.mainMenuPlayButton,
        Assets.mainMenuPlayButtonClicked);
    ...
    helpButton = new Button((utils.CANVAS_WIDTH - Assets.mainMenuHelpButton.getWidth()) / 2,
        playButton.getY() + playButton.getHeight() + (int) (utils.CANVAS_HEIGHT * 0.02),
        Assets.mainMenuHelpButton, Assets.mainMenuHelpButtonClicked);
    optionsButton = new Button((utils.CANVAS_WIDTH - Assets.mainMenuOptionsButton.getWidth()) / 2,
        helpButton.getY() + helpButton.getHeight() + (int) (utils.CANVAS_HEIGHT * 0.02),
        Assets.mainMenuOptionsButton, Assets.mainMenuOptionsButtonClicked);
  ...
  public void present(float deltaTime) {
    ...
    Constants.drawScore(g, Assets.newScoreDigits, "" + Settings.highscore, utils.CANVAS_WIDTH,
        scoreY);
  }
