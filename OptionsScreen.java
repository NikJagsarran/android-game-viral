...
public class OptionsScreen extends Screen {
	...
	private void initialize() {
		...
		buttonVerticalSpacing = ((int) (utils.CANVAS_HEIGHT * 0.95) - (Assets.optionsScreenTitle.getHeight()
				+ Assets.optionsScreenNeutralButton.getHeight() + Assets.optionsScreenSoundButton.getHeight()
				+ Assets.optionsScreenBackButton.getHeight())) / 4;
		
		calibrateButton = new Button((utils.CANVAS_WIDTH
				- Assets.optionsScreenNeutralButton.getWidth()) / 2, Assets.optionsScreenTitle.getHeight()
				+ (int) (utils.CANVAS_HEIGHT * 0.05) + buttonVerticalSpacing,
				Assets.optionsScreenNeutralButton, Assets.optionsScreenNeutralButtonClicked);
