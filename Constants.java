...
public final class Constants {
	...
	public static void drawScore(Graphics g, Pixmap digits, String score, int right, int top, int alpha) {
    	...
    	for (int i = 0; i < numChars; i++) {
    		...
    		g.drawPixmap(digits, currX, top, currDigit * Constants.SCORE_DIGIT_WIDTH, 0, Constants.SCORE_DIGIT_WIDTH,
    				Assets.scoreDigits.getHeight(), alpha);
