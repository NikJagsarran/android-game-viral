...
public class CalibrateScreen1 extends Screen {
  ...
  private void initialize() {
    ...
    betweenNoAndYes = (utils.CANVAS_WIDTH - Assets.calibrateScreen1No.getWidth() - Assets.calibrateScreen1Yes
        .getWidth()) / 3;
    ...
    spacingBetweenTextsAndImages = (noButton.getY() - (text1Y
        + Assets.calibrateScreen1Text1.getHeight() + Assets.calibrateScreen1Head.getHeight() + Assets.calibrateScreen1Text2
        .getHeight())) / 3;
    ...
    deviceY = (int) (deviceTextY - Assets.calibrateScreen1Device.getHeight() - (int) (utils.CANVAS_HEIGHT * 0.03));

    text2X = (utils.CANVAS_WIDTH - Assets.calibrateScreen1Text2.getWidth()) / 2;
    text2Y = deviceTextY + Assets.calibrateScreen1DeviceText.getHeight()
        + spacingBetweenTextsAndImages;
    ...
    resetPopupNoYesButtonsY = resetPopupBGY
        + (int) (0.9 * Assets.calibrateScreen1ResetPopupBG.getHeight()) - noButton.getHeight();
    resetPopupBetweenNoYes = (Assets.calibrateScreen1ResetPopupBG.getWidth() - noButton.getWidth() - yesButton
        .getWidth()) / 3;

    resetPopupNoButton = new Button(resetPopupBGX + resetPopupBetweenNoYes,
        resetPopupNoYesButtonsY, Assets.calibrateScreen1No, Assets.calibrateScreen1NoClicked);
    resetPopupYesButton = new Button(resetPopupBGX + resetPopupNoButton.getWidth() + 2
        * resetPopupBetweenNoYes, resetPopupNoYesButtonsY, Assets.calibrateScreen1Yes,
        Assets.calibrateScreen1YesClicked);
  }
  ...
  private void createResetButton() {
    ...
    resetButton = new Button((utils.CANVAS_WIDTH - resetButtonImage.getWidth()) / 2, resetButtonY,
        resetButtonImage, resetButtonClickedImage);
  }
