...
public class Virus {
  ...
  public boolean touchingAntiVirus(int virusX, int virusY) {
    Rect virusRectangle = new Rect(virusX, virusY, virusX + Assets.virus.getWidth(), virusY
        + Assets.virus.getHeight());
    Rect antiVirusRectangle = new Rect(x, y, x + Assets.antiVirus.getWidth(), y
